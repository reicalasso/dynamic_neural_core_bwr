"""
Simple overfitting test for the enhanced DNC model.

This script tests if the enhanced DNC model can overfit on a very small dataset,
...
def test_overfitting():
    """Test if the enhanced DNC model can overfit on a small dataset."""
    print("Testing enhanced DNC model overfitting capability...")
    ...
    if initial_loss > final_loss:
        print("✓ Enhanced DNC model can learn - overfitting test passed!")
        return True
    else:
        print("✗ Enhanced DNC model cannot learn - there may be an issue with the implementation")
        return False
