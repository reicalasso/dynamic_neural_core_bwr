"""
Simple overfitting test for the minimal enhanced DNC model.

This script tests if the minimal enhanced DNC model can overfit on a very small dataset,
...
def test_overfitting():
    """Test if the minimal enhanced DNC model can overfit on a small dataset."""
    print("Testing minimal enhanced DNC model overfitting capability...")
    ...
    if initial_loss > final_loss:
        print("✓ Minimal enhanced DNC model can learn - overfitting test passed!")
        return True
    else:
        print("✗ Minimal enhanced DNC model cannot learn - there may be an issue with the implementation")
        return False
